"""Final code from Neural Networks from Scratch in Python

https://github.com/Sentdex/nnfs_book/blob/main/Chapter_22/Ch22_Final.py

Committed for reference, principally to make it easier to work out which
NumPy operations have to be re-implemented in order to build a neural
network with (at least) the same functionality as that in the book.

The only changes made to this file are a couple of 'noqa: F541' comments
