...
class TensorBackend[T](Protocol):
    ...
    def full(self, shape: tuple[int, ...], fill_value: Scalar) -> T:
        """
    ...
    def full_like(self, x: T, fill_value: Scalar) -> T:
        """
    ...
    def subtract(self, a: T, b: T | Scalar) -> T:
        """
    ...
    def multiply(self, a: T, b: T | Scalar) -> T:
        """
    ...
    def divide(self, a: T, b: T | Scalar) -> T:
        """
    ...
    def maximum(self, a: T, b: T | Scalar) -> T:
        """
    ...
    def minimum(self, a: T, b: T | Scalar) -> T:
        """
    ...
    def clip(self, x: T, min_value: Scalar, max_value: Scalar) -> T:
        """
